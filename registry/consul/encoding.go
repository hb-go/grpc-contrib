...
func encodeMethods(en []*registry.Method) []string {
	var tags []string
	for _, e := range en {
		if b, err := json.Marshal(e); err == nil {
			tags = append(tags, "m-"+encode(b))
		}
	}
	return tags
}

func decodeMethods(tags []string) []*registry.Method {
	var en []*registry.Method
